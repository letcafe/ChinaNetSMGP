...
public class TSMGP_SUBMIT implements SMGPRequestBody {
    ...
    public static void main(String[] arg)
    {
        ...
        submit.sSrcTermID="10659805006";
        submit.sChargeTermID="17822000706";
        
   
        submit.sDestTermID="17822000706";
        
        submit.ucMsgFormat=15;
        
        submit.sMsgContent="厦航短信测试！收到请回电0592-5739246厦航短信测试！收到请回电0592-5739246厦航短信测试！收到请回电0592-5739246厦航短信测试！收到请回电0592-5739246厦航短信测试！收到请回电0592-5739246";//sxit测试短信5555566";
      
        submit.sReserve="";
        
        submit.getRequestBody();
    }
}
